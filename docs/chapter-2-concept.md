...
The camp breeze is 6 dB above the valley level, and the owl has greater reach across the clearing. The arrival text and Juno recording now say “The day is turning into night.” Jonathan's two spoken lines now use the user-selected Petra voice in place of Julian.
