...
| G12 | shared | Faith Journey map with all five planned stories | normal UI | soft music | implementation complete on `feature/chapter-3`; capture needed after a visual layout check at phone and tablet aspect ratios |
