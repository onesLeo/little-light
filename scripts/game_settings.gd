...
## Calmer movement for a child who feels unwell with motion: the sea in Jonah's journey barely
## rolls, and nothing tilts. The story is the same. In the pause menu.
...
static func load_settings() -> void:
	...
	if cfg.load(PATH) == OK:
		...
		reduced_motion = bool(cfg.get_value("story", "reduced_motion", false))
...
static func save_settings() -> void:
	...
	cfg.set_value("story", "reduced_motion", reduced_motion)
